...
const VESSELS = [
  { name: 'LNG ADAMAWA', capacity: 141090, dwt: 79581, pitch: 7.8329, class: 'Rivers' },
  { name: 'LNG AKWA-IBOM', capacity: 141090, dwt: 79581, pitch: 7.8329, class: 'Rivers' },
  { name: 'LNG BAYELSA', capacity: 137100, dwt: 79822, pitch: 7.52, class: 'Rivers Plus' },
  { name: 'LNG CROSS-RIVER', capacity: 141090, dwt: 79581, pitch: 7.8329, class: 'Rivers' },
  { name: 'LNG RIVERS', capacity: 137100, dwt: 79822, pitch: 7.52, class: 'Rivers Plus' },
  { name: 'LNG RIVER-NIGER', capacity: 141090, dwt: 79581, pitch: 7.8329, class: 'Rivers' },
  { name: 'LNG SOKOTO', capacity: 137100, dwt: 79822, pitch: 7.52, class: 'Rivers Plus' },
];
...
async function seed() {
  ...
  try {
    ...
    for (const v of VESSELS) {
      ...
      await c.query(`INSERT INTO lng_vessels (name, capacity_m3, dwt, pitch, vessel_class, foe_factor, laden_boiloff_pct, ballast_boiloff_pct, cf_hfo, cf_foe) VALUES ($1,$2,$3,$4,$5,0.484,$6,$7,3.114,2.750) ON CONFLICT (name) DO UPDATE SET capacity_m3=$2, dwt=$3, pitch=$4, vessel_class=$5, laden_boiloff_pct=$6, ballast_boiloff_pct=$7`,
        [v.name, v.capacity, v.dwt, v.pitch, v.class, boiloffLaden, boiloffBallast]);
    }
